...
sens <- glm(eitherRectalPos~1 + ageM + visiblestoolonswab1 + loosewat1 + condensation, family = binomial(link="logit"), 
            data=d2)

coef(summary(sens))

sens2 <- glm(rectal1_pos~1 + ageM + visiblestoolonswab1 + loosewat1 + condensation, family = binomial(link="logit"), 
            data=d2)
...
print(xtable(sens, caption = "Effects of age, visable detection of stool, and stool consistancy on rectal swab sensitivity"), caption.placement = getOption("xtable.caption.placement", "top"))
...
colnames(sensSpec) <- c("", "Total (N = 57)", "Loose or watery (N = 11)", "Condensation (N = 75)", "Soiled (N = 15)", "< 12 months (N = 11)")

stargazer(sensSpec, summary = FALSE, rownames = FALSE, title = "Covariate effects on sensitivity, specificity, and predictive value of rectal swabs for molecular detection of {\\emph{Giardia duodenalis}}")
...
stargazer(sensSpec, summary = FALSE, rownames = FALSE, title = "Covariate effects on sensitivity and specificity of rectal swabs for the real-time PCR detection of Giardia duodenalis")
```
...
stargazer(replicateSummary, type = "latex", summary = FALSE, rownames = FALSE, title = "PCR positivity and mean CT value by specimen replicate group")
...
stargazer(sensitivitySummary, type = "latex", summary = FALSE, rownames = FALSE, title = "PCR negativity and diagnostic sensitivity by specimen replicate group")

# SEQUENCES TABLE
seqTable <- read_csv("/Users/razel/Dropbox/Rectal swab STH/Analysis/LaTex and CSV tables/giardia_sequences_table.csv")

stargazer(seqTable, type = "latex", summary = FALSE, rownames = FALSE, title = "DNA target, primer, and probe sequences for the real-time PCR detection of Giardia duodenalis")
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/scatter_by_duplicate_7-22.jpg", plot=last_plot(), width=6, height=6)
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/scatter_stool_replicates.jpg", plot=last_plot(), width=6, height=6)
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/scatter_rectal_replicates.jpg", plot=last_plot(), width=6, height=6)
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/giardia_boxplot.jpg", plot=last_plot(), width=6, height=6)
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/giardia_boxplot_ALL.jpg", plot=last_plot(), width=6, height=6)
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/ct_quartile.jpg", plot=last_plot(), width=8, height=6)
```
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/consistency_boxplot.jpg", plot=last_plot(), width=6, height=6)
```
...
#ggsave("/Users/razel/Dropbox/Rectal swab STH/Analysis/Results/ct_smooth.jpg", plot=last_plot(), width=8, height=6)
```